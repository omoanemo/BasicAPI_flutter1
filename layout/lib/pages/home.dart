...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("App knowledge about computer"),
  ...
  Future getData() async {
    //https://raw.githubusercontent.com/omoanemo/BasicAPI_flutter1/main/data.json
    var url = Uri.https('raw.githubusercontent.com','/omoanemo/BasicAPI_flutter1/main/data.json');
